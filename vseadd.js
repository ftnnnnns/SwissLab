    ...
    return (
        <View style={styles.container}>
            <ScrollView showsVerticalScrollIndicator={false} style={styles.topButtonsContainer}>
                <TouchableOpacity style={styles.Btnn} onPress={() => navigation.navigate('Tashkent')}>
                    <Text style={styles.buttonText1}>Ташкент{'\n'}<Text style={styles.subText}>(14 лабораторий)</Text></Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles.Btnnz} onPress={() => navigation.navigate('Samarcand')}>
                    <Text style={styles.buttonText1}>Самарканд{'\n'}<Text style={styles.subText}>(2 лаборатории)</Text></Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles.Btnn} onPress={() => navigation.navigate('Angren')}>
                    <Text style={styles.buttonText1}>Ангрен{'\n'}<Text style={styles.subText}>(1 лаборатория)</Text></Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles.Btnnz} onPress={() => navigation.navigate('Gulistan')}>
...
const styles = StyleSheet.create({
    ...
    Btnn: {
        backgroundColor: "#00BFFF", // Голубой цвет
        paddingVertical: 15,
        paddingHorizontal: 30,
        borderRadius: 7,
        borderWidth: 2,
    ...
    Btnnz: {
        backgroundColor: "#c71414", // Нежно фиолетовый цвет
        paddingVertical: 15,
        paddingHorizontal: 30,
        borderRadius: 7,
        borderWidth: 2,
